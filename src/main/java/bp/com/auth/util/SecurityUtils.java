package bp.com.auth.util;

import bp.com.auth.models.domain.User;
import bp.com.auth.security.AuthenticationToken;
...
public class SecurityUtils {
    ...
    /**
     * Creates an authentication token based on the specified user details and sets it to the current thread's
     * context.
     *
